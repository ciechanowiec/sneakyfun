...
public interface SneakySupplier<T, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param supplier sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> Supplier<T> sneaky(SneakySupplier<T, X> supplier) {
