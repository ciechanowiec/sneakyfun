 ...
 */
@FunctionalInterface
public interface SneakyDoubleFunction<R, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param doubleFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<R, X extends Exception> DoubleFunction<R> sneaky(SneakyDoubleFunction<R, X> doubleFunction) {
