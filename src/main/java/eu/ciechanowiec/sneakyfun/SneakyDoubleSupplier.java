 ...
 * {@code double}-producing primitive specialization of {@link SneakySupplier}.
 *
...
public interface SneakyDoubleSupplier<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param doubleSupplier sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleSupplier sneaky(SneakyDoubleSupplier<X> doubleSupplier) {
