 ...
 * {@link SneakyConsumer} for {@code long}.  Unlike most other functional interfaces,
...
public interface SneakyLongConsumer<X extends Exception> {
     ...
     */
    void accept(long input) throws X;
     ...
     *   </li>
     * </ol>
     * @param longConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongConsumer sneaky(SneakyLongConsumer<X> longConsumer) {
