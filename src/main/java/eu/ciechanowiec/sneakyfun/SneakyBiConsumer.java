 ...
 * result. This is the two-arity specialization of {@link SneakyConsumer}.
...
public interface SneakyBiConsumer<T, U, X extends Exception> {
     ...
     */
    void accept(T inputOne, U inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param biConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, U, X extends Exception> BiConsumer<T, U> sneaky(SneakyBiConsumer<T, U, X> biConsumer) {
        Objects.requireNonNull(biConsumer);
        return (inputOne, inputTwo) -> {
            try {
                biConsumer.accept(inputOne, inputTwo);
