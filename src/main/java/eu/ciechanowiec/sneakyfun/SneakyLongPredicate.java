 ...
 */
@FunctionalInterface
public interface SneakyLongPredicate<X extends Exception> {
     ...
     */
    boolean test(long input) throws X;
     ...
     *   </li>
     * </ol>
     * @param longPredicate sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongPredicate sneaky(SneakyLongPredicate<X> longPredicate) {
        Objects.requireNonNull(longPredicate);
        return input -> {
            try {
                return longPredicate.test(input);
