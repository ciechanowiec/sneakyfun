...
public interface SneakyIntToLongFunction<X extends Exception> {
     ...
     */
    long applyAsLong(int input) throws X;
     ...
     *   </li>
     * </ol>
     * @param intToLongFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntToLongFunction sneaky(SneakyIntToLongFunction<X> intToLongFunction) {
        Objects.requireNonNull(intToLongFunction);
        return input -> {
            try {
                return intToLongFunction.applyAsLong(input);
