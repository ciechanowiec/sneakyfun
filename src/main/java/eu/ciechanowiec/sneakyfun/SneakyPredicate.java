...
public interface SneakyPredicate<T, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param predicate sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> Predicate<T> sneaky(SneakyPredicate<T, X> predicate) {
