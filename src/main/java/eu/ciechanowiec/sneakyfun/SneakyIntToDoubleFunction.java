...
public interface SneakyIntToDoubleFunction<X extends Exception> {
     ...
     */
    double applyAsDouble(int input) throws X;
     ...
     *   </li>
     * </ol>
     * @param intToDoubleFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntToDoubleFunction sneaky(SneakyIntToDoubleFunction<X> intToDoubleFunction) {
        Objects.requireNonNull(intToDoubleFunction);
        return input -> {
            try {
                return intToDoubleFunction.applyAsDouble(input);
