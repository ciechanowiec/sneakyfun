 ...
 * {@code long}-producing primitive specialization of {@link SneakySupplier}.
 *
...
public interface SneakyLongSupplier<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param longSupplier sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongSupplier sneaky(SneakyLongSupplier<X> longSupplier) {
