 ...
 */
@FunctionalInterface
public interface SneakyLongToIntFunction<X extends Exception> {
     ...
     */
    int applyAsInt(long input) throws X;
     ...
     *   </li>
     * </ol>
     * @param longToIntFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongToIntFunction sneaky(SneakyLongToIntFunction<X> longToIntFunction) {
        Objects.requireNonNull(longToIntFunction);
        return input -> {
            try {
                return longToIntFunction.applyAsInt(input);
