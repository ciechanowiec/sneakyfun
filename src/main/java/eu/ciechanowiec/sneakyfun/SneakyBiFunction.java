 ...
 * This is the two-arity specialization of {@link SneakyFunction}.
 *
...
public interface SneakyBiFunction<T, U, R, X extends Exception> {
     ...
     */
    R apply(T inputOne, U inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param biFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, U, R, X extends Exception> BiFunction<T, U, R> sneaky(SneakyBiFunction<T, U, R, X> biFunction) {
        Objects.requireNonNull(biFunction);
        return (inputOne, inputTwo) -> {
            try {
                return biFunction.apply(inputOne, inputTwo);
