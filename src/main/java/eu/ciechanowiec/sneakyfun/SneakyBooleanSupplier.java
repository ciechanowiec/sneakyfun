 ...
 * {@code boolean}-producing primitive specialization of {@link SneakySupplier}.
 *
...
public interface SneakyBooleanSupplier<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param booleanSupplier sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> BooleanSupplier sneaky(SneakyBooleanSupplier<X> booleanSupplier) {
