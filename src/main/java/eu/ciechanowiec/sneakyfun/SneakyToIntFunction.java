 ...
 * {@code int}-producing primitive specialization for {@link SneakyFunction}.
 *
...
public interface SneakyToIntFunction<T, X extends Exception> {
     ...
     */
    int applyAsInt(T input) throws X;
     ...
     *   </li>
     * </ol>
     * @param toIntFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> ToIntFunction<T> sneaky(SneakyToIntFunction<T, X> toIntFunction) {
