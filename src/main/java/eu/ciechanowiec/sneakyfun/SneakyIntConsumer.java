 ...
 * {@link SneakyConsumer} for {@code int}.  Unlike most other functional interfaces,
 ...
 */
@FunctionalInterface
public interface SneakyIntConsumer<X extends Exception> {
     ...
     */
    void accept(int input) throws X;
     ...
     *   </li>
     * </ol>
     * @param intConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntConsumer sneaky(SneakyIntConsumer<X> intConsumer) {
