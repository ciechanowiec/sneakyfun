 ...
 * {@link SneakyUnaryOperator} for {@code double}.
 *
...
public interface SneakyDoubleUnaryOperator<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param doubleUnaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleUnaryOperator sneaky(SneakyDoubleUnaryOperator<X> doubleUnaryOperator) {
