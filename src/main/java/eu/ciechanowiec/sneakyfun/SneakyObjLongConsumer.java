 ...
 * {@code (reference, long)} specialization of {@link SneakyBiConsumer}.
...
public interface SneakyObjLongConsumer<T, X extends Exception> {
     ...
     */
    void accept(T inputOne, long inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param objLongConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> ObjLongConsumer<T> sneaky(SneakyObjLongConsumer<T, X> objLongConsumer) {
        Objects.requireNonNull(objLongConsumer);
        return (inputOne, inputTwo) -> {
            try {
                objLongConsumer.accept(inputOne, inputTwo);
