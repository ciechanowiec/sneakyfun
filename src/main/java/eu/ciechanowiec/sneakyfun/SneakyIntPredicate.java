 ...
 */
@FunctionalInterface
public interface SneakyIntPredicate<X extends Exception> {
    ...
    boolean test(int input) throws X;
     ...
     *   </li>
     * </ol>
     * @param intPredicate sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntPredicate sneaky(SneakyIntPredicate<X> intPredicate) {
        Objects.requireNonNull(intPredicate);
        return input -> {
            try {
                return intPredicate.test(input);
