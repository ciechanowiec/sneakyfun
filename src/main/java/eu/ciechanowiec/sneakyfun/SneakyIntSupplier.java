 ...
 * {@code int}-producing primitive specialization of {@link SneakySupplier}.
 *
...
public interface SneakyIntSupplier<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param intSupplier sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntSupplier sneaky(SneakyIntSupplier<X> intSupplier) {
