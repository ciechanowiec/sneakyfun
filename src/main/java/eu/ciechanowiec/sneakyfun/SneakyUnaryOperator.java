...
public interface SneakyUnaryOperator<T, X extends Exception> extends SneakyFunction<T, T, X> {
     ...
     *   </li>
     * </ol>
     * @param unaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> UnaryOperator<T> sneaky(SneakyUnaryOperator<T, X> unaryOperator) {
        Objects.requireNonNull(unaryOperator);
        return input -> {
            try {
                return unaryOperator.apply(input);
