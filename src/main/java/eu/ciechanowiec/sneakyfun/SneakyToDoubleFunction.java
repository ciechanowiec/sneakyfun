 ...
 * {@code double}-producing primitive specialization for {@link SneakyFunction}.
 *
...
public interface SneakyToDoubleFunction<T, X extends Exception> {
     ...
     */
    double applyAsDouble(T input) throws X;
     ...
     *   </li>
     * </ol>
     * @param toDoubleFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> ToDoubleFunction<T> sneaky(SneakyToDoubleFunction<T, X> toDoubleFunction) {
        Objects.requireNonNull(toDoubleFunction);
        return input -> {
            try {
                return toDoubleFunction.applyAsDouble(input);
