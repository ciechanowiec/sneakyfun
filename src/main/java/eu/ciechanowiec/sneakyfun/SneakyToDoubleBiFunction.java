...
public interface SneakyToDoubleBiFunction<T, U, X extends Exception> {
     ...
     *
     * @param inputOne the first function argument
     * @param inputTwo the second function argument
     * @return the function result
     * @throws X if an exception during execution of this method was thrown
     */
    double applyAsDouble(T inputOne, U inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param toDoubleBiFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, U, X extends Exception> ToDoubleBiFunction<T, U> sneaky(SneakyToDoubleBiFunction<T, U, X> toDoubleBiFunction) {
        Objects.requireNonNull(toDoubleBiFunction);
        return (inputOne, inputTwo) -> {
            try {
                return toDoubleBiFunction.applyAsDouble(inputOne, inputTwo);
