...
public interface SneakyLongFunction<R, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param longFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<R, X extends Exception> LongFunction<R> sneaky(SneakyLongFunction<R, X> longFunction) {
        Objects.requireNonNull(longFunction);
        return input -> {
            try {
                return longFunction.apply(input);
