 ...
 * {@code long}-producing primitive specialization for {@link SneakyFunction}.
 *
...
public interface SneakyToLongFunction<T, X extends Exception> {
     ...
     */
    long applyAsLong(T input) throws X;
     ...
     *   </li>
     * </ol>
     * @param toLongFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> ToLongFunction<T> sneaky(SneakyToLongFunction<T, X> toLongFunction) {
        Objects.requireNonNull(toLongFunction);
        return input -> {
            try {
                return toLongFunction.applyAsLong(input);
