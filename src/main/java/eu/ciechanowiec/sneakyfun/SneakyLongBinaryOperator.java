 ...
 * {@link SneakyBinaryOperator} for {@code long}.
 *
...
public interface SneakyLongBinaryOperator<X extends Exception> {
     ...
     */
    long applyAsLong(long leftOperand, long rightOperand) throws X;
     ...
     *   </li>
     * </ol>
     * @param longBinaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongBinaryOperator sneaky(SneakyLongBinaryOperator<X> longBinaryOperator) {
        Objects.requireNonNull(longBinaryOperator);
        return (leftOperand, rightOperand) -> {
            try {
                return longBinaryOperator.applyAsLong(leftOperand, rightOperand);
