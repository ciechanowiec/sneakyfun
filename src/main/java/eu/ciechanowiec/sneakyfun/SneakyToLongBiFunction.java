...
public interface SneakyToLongBiFunction<T, U, X extends Exception> {
     ...
     */
    long applyAsLong(T inputOne, U inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param toLongBiFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, U, X extends Exception> ToLongBiFunction<T, U> sneaky(SneakyToLongBiFunction<T, U, X> toLongBiFunction) {
        Objects.requireNonNull(toLongBiFunction);
        return (inputOne, inputTwo) -> {
            try {
                return toLongBiFunction.applyAsLong(inputOne, inputTwo);
