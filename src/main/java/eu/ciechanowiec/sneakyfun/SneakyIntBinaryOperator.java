 ...
 * {@link SneakyBinaryOperator} for {@code int}.
 *
...
public interface SneakyIntBinaryOperator<X extends Exception> {
     ...
     */
    int applyAsInt(int leftOperand, int rightOperand) throws X;
     ...
     *   </li>
     * </ol>
     * @param intBinaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> IntBinaryOperator sneaky(SneakyIntBinaryOperator<X> intBinaryOperator) {
