 ...
 * {@link SneakyUnaryOperator} for {@code long}.
 *
 ...
 */
@FunctionalInterface
public interface SneakyLongUnaryOperator<X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param longUnaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> LongUnaryOperator sneaky(SneakyLongUnaryOperator<X> longUnaryOperator) {
