...
public interface SneakyConsumer<T, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param consumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> Consumer<T> sneaky(SneakyConsumer<T, X> consumer) {
