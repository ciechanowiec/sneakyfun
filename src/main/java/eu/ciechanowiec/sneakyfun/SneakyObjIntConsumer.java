 ...
 * {@code (reference, int)} specialization of {@link SneakyBiConsumer}.
...
public interface SneakyObjIntConsumer<T, X extends Exception> {
     ...
     */
    void accept(T inputOne, int inputTwo) throws X;
     ...
     *   </li>
     * </ol>
     * @param objIntConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<T, X extends Exception> ObjIntConsumer<T> sneaky(SneakyObjIntConsumer<T, X> objIntConsumer) {
        Objects.requireNonNull(objIntConsumer);
        return (inputOne, inputTwo) -> {
            try {
                objIntConsumer.accept(inputOne, inputTwo);
