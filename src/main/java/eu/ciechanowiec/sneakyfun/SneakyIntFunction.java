...
public interface SneakyIntFunction<R, X extends Exception> {
     ...
     *   </li>
     * </ol>
     * @param intFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<R, X extends Exception> IntFunction<R> sneaky(SneakyIntFunction<R, X> intFunction) {
        Objects.requireNonNull(intFunction);
        return input -> {
            try {
                return intFunction.apply(input);
