 ...
 * {@link SneakyBinaryOperator} for {@code double}.
 *
 ...
 */
@FunctionalInterface
public interface SneakyDoubleBinaryOperator<X extends Exception> {
    /**
     ...
     */
    double applyAsDouble(double leftOperand, double rightOperand) throws X;
     ...
     *   </li>
     * </ol>
     * @param doubleBinaryOperator sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleBinaryOperator sneaky(SneakyDoubleBinaryOperator<X> doubleBinaryOperator) {
        Objects.requireNonNull(doubleBinaryOperator);
        return (leftOperand, rightOperand) -> {
            try {
                return doubleBinaryOperator.applyAsDouble(leftOperand, rightOperand);
