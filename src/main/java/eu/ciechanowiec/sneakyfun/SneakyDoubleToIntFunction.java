...
public interface SneakyDoubleToIntFunction<X extends Exception> {
     ...
     */
    int applyAsInt(double input) throws X;
     ...
     *   </li>
     * </ol>
     * @param doubleToIntFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleToIntFunction sneaky(SneakyDoubleToIntFunction<X> doubleToIntFunction) {
        Objects.requireNonNull(doubleToIntFunction);
        return input -> {
            try {
                return doubleToIntFunction.applyAsInt(input);
