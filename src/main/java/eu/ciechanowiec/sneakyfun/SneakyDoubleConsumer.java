 ...
 * {@link SneakyConsumer} for {@code double}.  Unlike most other functional interfaces,
...
public interface SneakyDoubleConsumer<X extends Exception> {
     ...
     */
    void accept(double input) throws X;
     ...
     *   </li>
     * </ol>
     * @param doubleConsumer sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleConsumer sneaky(SneakyDoubleConsumer<X> doubleConsumer) {
