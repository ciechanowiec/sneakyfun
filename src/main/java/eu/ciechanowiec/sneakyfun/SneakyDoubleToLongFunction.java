...
public interface SneakyDoubleToLongFunction<X extends Exception> {
     ...
     */
    long applyAsLong(double input) throws X;
     ...
     *   </li>
     * </ol>
     * @param doubleToLongFunction sneaky functional interface that will be wrapped into the analogous
    ...
    static<X extends Exception> DoubleToLongFunction sneaky(SneakyDoubleToLongFunction<X> doubleToLongFunction) {
        Objects.requireNonNull(doubleToLongFunction);
        return input -> {
            try {
                return doubleToLongFunction.applyAsLong(input);
